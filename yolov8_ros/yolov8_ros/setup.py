...
setup(
    ...
    entry_points={
        'console_scripts': [
                ...
                'hand_node = yolov8_ros.hand_node:main',
                'debug_node = yolov8_ros.debug_node:main',
                'class_position = yolov8_ros.class_position:main',
                'tracking_node = yolov8_ros.tracking_node:main',
                'topic_merger = yolov8_ros.topic_merger:main',
                'zed_frame_listener = yolov8_ros.zed_frame_listener:main',
                'detect_3d_node = yolov8_ros.detect_3d_node:main',
                'frame_tf_node = yolov8_ros.frame_tf_node:main'
